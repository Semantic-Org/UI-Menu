...
This repository contains pre-compiled menu files using the default themes. This is intended for use in projects that do not need all the bells and whistles of Semantic UI, and want to keep file size to a minimum.
...
```
bower install semantic-ui-menu
```

#### To install with NPM
```
npm install semantic-ui-menu
```

#### To install with Meteor
```
meteor add semantic:ui-menu
```
